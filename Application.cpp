...
void Application::toggleBezierControlPointsMode()
{
    addBezierControlPointsMode = !addBezierControlPointsMode;

    if (addBezierControlPointsMode)
    {
        printf("BEZIER CONTROL POINTS MODE ENABLED\n");
    }
    else
    {
        printf("BEZIER CONTROL POINTS MODE DISABLED\n");
    }
}
...
void Application::handleLeftClick()
{
    ...
    if (addBezierControlPointsMode && sceneNow == 8)
    {
...
void Application::createShaders()
{
    ...
    // formula1 scene 8
    shaderFormula1Texture2 = createShaderProgram("../../Shaders/PhongVertexShader.vert", "../../Shaders/PhongFragmentShader.frag", glm::vec3(1.f));
}
...
void Application::createBuffers()
{
    ...
    objectLogin = createModelAndObjectFromFile("login.obj", shaderMoon);
...
void Application::buildScene()
{
    ...
    scene8logic = new Scene8();
    scene8 = Scene8::Build(this, scene8logic);
